...
contract MerkleClaim {
    ...
    constructor(address _avo, bytes32 _merkleRoot) {
        AVO = IAvo(_avo);
    ...
    function claim(
        ...
        require(AVO.claim(to, amount), "CLAIM_FAILED");
