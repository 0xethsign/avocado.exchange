...
contract RedeemTest is BaseTest {
    ...
    uint256 public constant redeemableAVO = 10e6 * 1e18;
    ...
    function setUp() public {
        ...
        AVO.setRedemptionReceiver(address(receiver));
        ...
        AVO.setMerkleClaim(address(claim));
    }
    ...
    function testClaimAirdrop() public {
        ...
        uint256 preBalance = AVO.balanceOf(user);
        ...
        uint256 postBalance = AVO.balanceOf(user);
